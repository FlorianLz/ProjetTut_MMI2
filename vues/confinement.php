<head>
    <meta property="og:url"                content="https://parlonsharcelement.fr/etude-confinement" />
    <meta property="og:type"               content="website" />
    <meta property="og:title"              content="Étude sur l’évolution du harcèlement durant le confinement" />
    <meta property="og:description"        content="Étude sur l’évolution du harcèlement durant le confinement" />
    <meta property="og:image"              content="https://parlonsharcelement.fr/img/favicon.jpg" />
</head>
<div class="contenuaccueil">
    <div class="banniereaccueil ban_conf">
        <div class="couleur_banniere ban_confinement">
            <h1>Étude sur l’évolution du harcèlement durant le confinement</h1>
            <h3>Étude réalisée du 14 au 23 avril 2020.</h3>
            <!-- <a href="#">
    ...
    <h3 class="txtpdf">Cette étude est disponible au format PDF <a href="docs/etude-confinement.pdf" target="_blank" class="lien">ici</a>.</h3>

    <section >
        <h1 class="titreorange">Introduction</h1>
        <p class="txt">
            ...
            mais est-ce qu’il le subit d’une autre manière ?<br /><br />
            ...
            montrer aux mieux l’évolution du harcèlement durant cette période.<br /><br />
            Cette étude met en avant les données recueillies concernant les différents types de harcèlement existants.
        </p>
    </section>

    <section class="moral">
        <h1 class="titrenoir">Le harcèlement moral</h1>
        <p class="txt">
            ...
            effet, de dégrader les conditions de vie et/ou de travail d’une personne.<br /><br />
            ...
            retrouvent aux premiers rangs face à l’épidémie.<br /><br />
            ...
            pas parce qu’il est présent chez vos voisins que vous allez l’attraper aussi.<br /><br />
    ...
    <section class="rue">
        ...
        <p class="txt">
            ...
            ont subi durant cette période.<br />
    ...
    <section class="scolaire">
        <h1 class="titrenoir">Le harcèlement scolaire</h1>
        <p class="txt">
            Le harcèlement scolaire se caractérise par une répétition de violences,
            de moqueries ou d’intimidation dans un espace scolaire.<br /><br />
    ...
    <section class="cyber">
        <h1 class="titrenoir">Le cyber-harcèlement</h1>
        <p class="txt">
    ...
    <section class="maison">
        <h1 class="titrenoir">Le harcèlement à la maison</h1>
        <p class="txt">
            ...
            trouver un logement social.<br /><br />
    ...
    <section class="conclusion">
        <h1 class="titreorange">CONCLUSION</h1>
        <p class="txt">
